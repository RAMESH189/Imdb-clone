  ...
  return (
    ...
    <div class="py-8 px-4 mx-auto max-w-screen-xl lg:py-16 lg:px-6">
        <div class="mx-auto max-w-screen-sm text-center">
            ...
            <button onClick={() => reset()} class="mb-4 text-lg hover:bg-blue-800 font-bold bg-blue-700 rounded-md p-2 text-gray-100 dark:text-gray-200">Please try again</button>
        </div>   
    </div>
</div>
  )
